...
import { ASSET_ID, DECISION_LABELS, ONE, POLICY, REGISTRY, STOCK_TOKEN, formatUnits18, bpsToPercent, LIFECYCLE_LABELS } from "@/lib/contracts";
...
export function PolicyConsole() {
  ...
  const localDecision: Decision | undefined = capacity === undefined ? undefined : lifecycle === 3 ? "BLOCK" : parsedAmount <= capacity ? "ALLOW" : "LIMIT";
  const reason = localDecision ? DECISION_REASON[localDecision] : "Waiting for onchain asset state…";
