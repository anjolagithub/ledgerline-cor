...
export default function Activity() {
  return <main className="mx-auto flex max-w-6xl flex-col gap-8 px-5 py-6 md:px-10 md:py-8">
    ...
    <section className="border-b border-terminal-border pb-7"><p className="eyebrow">Onchain record</p><h1 className="mt-3 max-w-3xl text-3xl font-semibold tracking-tight md:text-4xl">Every decision that moved value.</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-terminal-muted">A read-only view of Deposited, Borrowed, Withdrawn, and Registry state changes, sourced directly from onchain logs.</p></section>
    <ActivityLog />
